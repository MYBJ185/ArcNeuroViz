...
def read_data(file_path):
    ...
    with open(file_path, 'rb') as fid:
        ...
        data_present, filesize, num_blocks, num_samples, record_time, sample_rate = (
            calculate_data_size(header, file_path, fid))
        print('File contains {:0.3f} seconds of data.'.format(record_time))
        print('Amplifiers were sampled at {:0.2f} kS/s.'.format(sample_rate / 1000))
    ...
    # Return 'result' dict.
    return result, record_time, sample_rate


if __name__ == '__main__':
    a, record_time, sample_rate = read_data("../demo_data/20221219/leftV1_1/s0633_0615_0690_221219_114735.rhd")
    print(a)
    # a = read_data("sampledata.rhd")
    ...
    # ax[1].set_ylabel('Aux')
    # ax[1].plot(a['t_aux_input'], a['aux_input_data'][1, :])
    ...
    # ax[3].set_ylabel('ADC')
    # ax[3].plot(a['t_board_adc'], a['board_adc_data'][2, :])
    # ax[3].margins(x=0, y=0)

    # ax[4].set_ylabel('Digin')
    # ax[4].plot(a['t_dig'], a['board_dig_in_data'][3, :])
    # ax[4].margins(x=0, y=0)

    # ax[5].set_ylabel('Digout')
    # ax[5].plot(a['t_dig'], a['board_dig_out_data'][4, :])
